...
class User(db.Model):
    ...
    userlogs = db.relationship('Userlog', backref='user')  # 日志外键关系关联字段
...
class Admin(db.Model):
    ...
    addtime = db.Column(db.DateTime, index=True, default=datetime.now)
    adminlogs = db.relationship('Adminlog', backref='admin')  # 电影收藏外键
    oplogs = db.relationship('Oplog', backref='admin')  # 电影收藏外键
...
#         name='chenmovie1',
#         # 生成哈希加密密码
#         pwd=generate_password_hash('chen'),
#         is_super=0,
#         role_id=1
#     )
